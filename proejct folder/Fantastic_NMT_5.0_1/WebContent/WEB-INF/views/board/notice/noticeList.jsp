...
<!--                     <i class="fas fa-plus" onclick="more();"></i>  -->
            ...
            <input type="button" id="write_btn" value="글쓰기" onclick="location.href='<%=request.getContextPath()%>/board/noticeWrite'" style="cursor:pointer;"/>
        	<%} %>
        </div>
        <!-- 공지사항 구현 끝 -->
        ...
        <div class="qna_wrap">
           ...
           <%--  <table class="qna_table">
             ...
             <table class="qna_table">
             <tr class="qna_q">
             	<td style="margin-left:10px;"><h2>Q.</h2><p><%=q.getBoardTItle() %></p><i class="fas fa-angle-down scroll_bnt"></i><i class="fas fa-angle-up scroll_up_bnt"></i></td>
             </tr>
            <tr class="bg_scroll">
            	<td ><h3>A.</h3><span><%=q.getBoardContent() %></span></td>
            </tr>
             </table>
             <%} %>
        </div>
