  ...
  <header>
    ...
    <section>
        ...
        <div class="btn_wrap_r">
        	<input type="button" id="write_review_btn" value="글쓰기" onclick="location.href='<%=request.getContextPath()%>/board/reviewWrite'" style="cursor:pointer;"/>
        </div>
        <%} %>
        <div class="recomand_list_r">
       <%if(list!=null){ %>
        <% for(Review r : list){ %>
            <div class="re_col1_r" style="cursor:pointer;">
