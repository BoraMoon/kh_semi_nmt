...
$(function(){
	...
	$("#btn-big2").click(function(){
		location.href = "<%=request.getContextPath()%>/member/packagebuy?memberCode=<%=m.getMcode()%>";
	});
             ...
             <div class="package_list">
              ...
              <%int discount = 3000000-packagePrice;%>
                <div class="mypage-select-result float-left" id="mypage-result-box">            
	       		...
	       		<button class="btn-big float-left" onclick="buyPackage();">구매하기</button>
       		 </div>
		    ...
		    if (rsp.success) { 
		         $.ajax({
		            ...
		            success:data => {
		            	...
		            	$(function(){
		            		$.ajax({
		            			url: "<%=request.getContextPath()%>/buy/memberMile.do",
		            			method : "POST",
		            			data : {
		            				userId : <%=m.getMcode()%>,
		            				price : <%=packagePrice%>,
